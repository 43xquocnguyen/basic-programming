...
int So_Sinh_Vien_Co_Ten_Can_Tim(SinhVien a[], int n, string tencantim) {
    int dem = 0;
    for (int i = 0; i < n; i++) {
...
void Xuat_Sinh_Vien_Can_Tim(SinhVien a[], int n, string tencantim) {
    if (So_Sinh_Vien_Co_Ten_Can_Tim(a, n, tencantim)) {
        int l = So_Sinh_Vien_Co_Ten_Can_Tim(a, n, tencantim);
        Xuat();
        for (int i = 0; i < l; i++) {
            cout << setfill(' ');
            cout << setw(8) << left << i + 1;
